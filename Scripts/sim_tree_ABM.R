...
save(sim_tree, file = sprintf("Results/sim_tree_nu-%s_omega-%s_sig2_rge-%s_sig2_mdp-%s_sim-%s.rda", nu, omega, sig2_rge, sig2_mdp, nsim))
...
for(tree in 1:3){
    ...
    mcmc_ABM(my_ABM, log.file = sprintf("Results/ABM_mcmc_nu-%s_omega-%s_sig2_rge-%s_sig2_mdp-%s_tree-%s_sim-%s.log", nu, omega, sig2_rge, sig2_mdp, tree, nsim),
